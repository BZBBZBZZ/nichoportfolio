...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    impact:
      "Built a functional e-commerce platform with key features including product management, payment integration using Midtrans, and delivery cost calculation using RajaOngkir API. Successfully implemented API integrations and deployed the website using Laravel Cloud, ensuring the application was accessible and fully operational. The product data displayed in the application uses dummy data generated through Laravel factories, as required by the project assessment criteria.",
    whatILearned:
